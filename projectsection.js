            ...
            <SimpleGrid autoColumns columns={{sm: 1, md: 3} } alignItems="stretch" spacingX={"5vw"} spacingY={"3vh"}>
                    <motion.div alignItems="stretch"
                        ...
                        <Card maxW='sm' bg={value} borderRadius={"3xl"} variant="outline">
                            <CardBody>
                            <Img src={"https://gqwwetbzszjdpomiwwsa.supabase.co/storage/v1/object/public/image/CleanShot%202023-01-08%20at%2016.22.29.jpeg"} borderRadius='lg'/>
                    ...
                    <motion.div height="100px" alignContent="stretch"
                        ...
                        <Card maxW='sm' bg={value} borderRadius={"3xl"} variant="outline">
                            <CardBody>
                            <Img src={"https://gqwwetbzszjdpomiwwsa.supabase.co/storage/v1/object/public/image/CleanShot%202023-01-08%20at%2016.26.42.jpeg"} borderRadius='lg'/>
                            <Stack mt='6' spacing='3'>
